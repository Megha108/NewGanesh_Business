...
export default function OwnerPhoto() {
  return (
    <div className="mx-6 sm:mx-0">
      {/* 🔹 Section 1 */}
      <section className="flex flex-col sm:flex-row items-center justify-start sm:justify-start sm:gap-[1px] p-[1px] sm:p-[1px] sm:pl-[5%] " style={{ marginTop: "-2%" }}>
      ...
      >
        ...
        <div className="max-w-xl text-left sm:text-left">
          ...
          <div className="mt-[0.5px] sm:mt-[1px]">
            <h3 className="text-lg font-semibold text-left sm:text-left">Sarah Mitchell</h3>
            <p className="text-gray-600 text-sm text-left sm:text-left">
              Product Manager, Bloom Labs
            </p>
          </div>
        </div>
      </section>
