  ...
  return (
    <section className="relative py-1 md:py-5 ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Rajka: static model + description */}
        <div className="mt-1 flex flex-col md:flex-row items-start gap-25">
        ...
        {/* Rajka: interactive model + description */}
        ...
        {/* Jaudo: static model + description */}
        <div className="mt-14 flex flex-col md:flex-row items-start gap-30">
          <div className="relative w-[250px] h-[300px] mx-auto md:mx-0 shadow-2xl rounded-xl bg-white mt-32">
            <Canvas camera={{ position: [0, 0, 5], fov: 40 }}>
              <ambientLight intensity={3} />
        ...
        {/* Jaudo: interactive model + description */}
        <div className="mt-14 flex flex-col md:flex-row items-start gap-30">
          <div className="relative w-[250px] h-[300px] mx-auto md:mx-0 shadow-2xl rounded-xl bg-white mt-32">
            <Canvas camera={{ position: [0, 0, 5], fov: 40 }}>
              <ambientLight intensity={3} />
